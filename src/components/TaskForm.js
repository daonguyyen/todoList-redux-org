...
export default class TaskForm extends Component {
    ...
    componentDidMount() { //Chi hien thi dc khi form chua xuat hien
        if (this.props.task) {
            this.setState({
    ...
    componentWillReceiveProps(nextProps) {
        ...
        } else if (!nextProps.task) { //Tuong duong : nextProps && nextProps.task === null
            //Truong hop bam sua roi bam them
            this.setState({
                id: '',
                name: '',
                status: false
